    ...
    <>
      ...
      <footer className="site-footer">
        <div className="wrap">
          ...
          <div className="footer-copy">© 2026 FIT50. All rights reserved. Pricing verified 2026 and subject to change; check the app store for the current rate in your region.</div>
        </div>
      </footer>

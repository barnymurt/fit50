...
export const ITEM_SERVING_OVERRIDES: Record<string, { grams: number; label: string }> = {
  ...
  // Canned goods
  'canned tuna': { grams: 142, label: '1 can (drained 85g)' },
  'canned salmon': { grams: 213, label: '1 can' },
  'canned sardines': { grams: 90, label: '1 can (drained)' },
  'canned anchovies': { grams: 5, label: '1 fillet' },
  'canned mackerel': { grams: 120, label: '1 can' },
  'canned oysters': { grams: 85, label: '1 can' },
  'canned clams': { grams: 140, label: '1 can' },
  'canned crab': { grams: 120, label: '1 can' },
  'canned shrimp': { grams: 140, label: '1 can' },
  'canned corned beef': { grams: 340, label: '1 can' },
  'canned spam': { grams: 28, label: '1 slice' },
  'canned chicken': { grams: 142, label: '1 can' },
  'canned ravioli': { grams: 425, label: '1 can' },
  'canned chili': { grams: 200, label: '1 serving' },
  'canned beef stew': { grams: 280, label: '1 can' },
  'canned chicken soup': { grams: 240, label: '1 cup' },
  'canned beans': { grams: 130, label: '1/2 cup' },
  'canned chickpeas': { grams: 130, label: '1/2 cup' },
  'canned lentils': { grams: 130, label: '1/2 cup' },
  'canned corn': { grams: 125, label: '1/2 cup' },
  'canned peas': { grams: 125, label: '1/2 cup' },
  'canned pumpkin': { grams: 125, label: '1/2 cup' },
  'canned tomatoes': { grams: 200, label: '1/2 can' },
  'canned tomato paste': { grams: 16, label: '1 tbsp' },
  'canned tomato sauce': { grams: 120, label: '1/2 cup' },
  'canned coconut milk': { grams: 120, label: '1/2 cup' },
  'canned coconut cream': { grams: 60, label: '1/4 cup' },
  'canned evaporated milk': { grams: 60, label: '1/4 cup' },
  'canned condensed milk': { grams: 30, label: '1 tbsp' },
  'canned peaches': { grams: 124, label: '1/2 cup' },
  'canned pineapple': { grams: 124, label: '1/2 cup' },
  'canned pears': { grams: 124, label: '1/2 cup' },
  'canned apricots': { grams: 124, label: '1/2 cup' },
  'canned mandarin': { grams: 110, label: '1/2 cup' },
  'canned cherries': { grams: 120, label: '1/2 cup' },
  'canned fruit cocktail': { grams: 124, label: '1/2 cup' },
  'canned lychees': { grams: 120, label: '1/2 cup' },
  'canned mango': { grams: 124, label: '1/2 cup' },
  'canned olives': { grams: 4, label: '1 olive' },
  'canned capers': { grams: 5, label: '1 tsp' },
  'canned sauerkraut': { grams: 30, label: '1 tbsp' },
  'canned jalapeños': { grams: 30, label: '1 tbsp' },
  'canned chipotle': { grams: 30, label: '1 tbsp' },
  'canned artichokes': { grams: 30, label: '1 piece' },
  'canned hearts of palm': { grams: 30, label: '1/2 cup' },
